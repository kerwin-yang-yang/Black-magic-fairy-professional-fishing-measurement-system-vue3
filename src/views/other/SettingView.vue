    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            <NotificationBar color="info" :icon="mdiInformation" :outline="notificationsOutline">
                ...
                <template #right>
                    <BaseButton label="Button" :color="notificationsOutline ? 'info' : 'white'"
            ...
            <NotificationBar color="success" :icon="mdiCheckCircle" :outline="notificationsOutline">
                ...
                <template #right>
                    <BaseButton label="Button" :color="notificationsOutline ? 'success' : 'white'"
                        :outline="notificationsOutline" rounded-full small />
                </template>
            </NotificationBar>
            ...
            <NotificationBar color="warning" :icon="mdiAlert" :outline="notificationsOutline">
                ...
                <template #right>
                    <BaseButton label="Button" :color="notificationsOutline ? 'warning' : 'white'"
                        :outline="notificationsOutline" rounded-full small />
                </template>
            </NotificationBar>
            ...
            <NotificationBar color="danger" :icon="mdiAlertCircle" :outline="notificationsOutline">
                ...
                <template #right>
                    <BaseButton label="Button" :color="notificationsOutline ? 'danger' : 'white'"
                        :outline="notificationsOutline" rounded-full small />
                </template>
            </NotificationBar>
            ...
            <CardBox>
                ...
                <BaseButtons>
                    ...
                    <BaseButton color="contrast" label="Button" :icon="mdiOpenInNew" :small="buttonsSmall"
                        :outline="buttonsOutline" :disabled="buttonsDisabled" :rounded-full="buttonsRounded" />
                    <BaseButton color="info" label="Button" :icon="mdiOpenInNew" :small="buttonsSmall"
                        :outline="buttonsOutline" :disabled="buttonsDisabled" :rounded-full="buttonsRounded" />
                    ...
                    <BaseButton color="warning" label="Button" :icon="mdiOpenInNew" :small="buttonsSmall"
                        :outline="buttonsOutline" :disabled="buttonsDisabled" :rounded-full="buttonsRounded" />
                    <BaseButton color="danger" label="Button" :icon="mdiOpenInNew" :small="buttonsSmall"
                        :outline="buttonsOutline" :disabled="buttonsDisabled" :rounded-full="buttonsRounded" />
                </BaseButtons>
        ...
        <SectionMain>
            <CardBox>
                ...
                <BaseButtons>
                    <PillTag color="contrast" label="Contrast" :small="pillsSmall" :outline="pillsOutline"
                        :icon="pillsIcon" />
                    <PillTag color="info" label="Info" :small="pillsSmall" :outline="pillsOutline" :icon="pillsIcon" />
                    <PillTag color="success" label="Success" :small="pillsSmall" :outline="pillsOutline"
                        :icon="pillsIcon" />
                    <PillTag color="warning" label="Warning" :small="pillsSmall" :outline="pillsOutline"
                        :icon="pillsIcon" />

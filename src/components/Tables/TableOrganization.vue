...
const emits = defineEmits(['showbutton', 'editbutton', 'deletebutton', 'freezebutton', 'stopbutton', 'checkedOnes'])
                    ...
                    <td class="before:hidden lg:w-1 whitespace-nowrap">
                        <BaseButtons type="justify-start lg:justify-end" no-wrap>
                            ...
                            <BaseButton :label="client.islocked == false ? '锁定' : '解锁'"
                                :color="client.islocked == false ? 'danger' : 'info'" :icon="mdiTrashCan" small

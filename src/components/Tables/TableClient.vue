...
defineEmits(['showbutton', 'editbutton', 'deletebutton', 'freezebutton', 'unfreezebutton'])
                    ...
                    <td class="before:hidden lg:w-1 whitespace-nowrap">
                        <BaseButtons type="justify-start lg:justify-end" no-wrap>
                            <BaseButton label="查看" color="info" :icon="mdiEye" small
                                @buttonclick="$emit('showbutton', client.id)" />
                            ...
                            <BaseButton label="冻结" color="danger" :icon="mdiEye" small
                                @buttonclick="$emit('freezebutton', client.id)" />
                            <BaseButton label="解冻" color="info" :icon="mdiTrashCan" small
                                @buttonclick="$emit('unfreezebutton', client.id)" />
